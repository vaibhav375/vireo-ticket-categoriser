...
"One command, about 80 seconds, no paid calls, no LLM needed, and 89 tests; every bug fix started with a failing test. The goal: cut wrong-team tickets from 17% to 5%, about Rs 1.5 lakh a quarter.
